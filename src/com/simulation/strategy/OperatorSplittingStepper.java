...
public class OperatorSplittingStepper implements IStepperStrategy {
    ...
    private final List<PhysicalModel> sequentialModels;
     ...
     */
    public OperatorSplittingStepper(IStepperStrategy baseStepper, List<PhysicalModel> sequentialModels) {
    ...
    public void step(PhysicalModel model, Field state, double dt) {
        ...
        for (PhysicalModel partModel : sequentialModels) {
